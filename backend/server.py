...
PARTNER_OFFERS = [
    ...
    # Brunch Spots
    {
        ...
        "image": "https://images.unsplash.com/photo-1765053729165-051392fa1dd2?w=800&q=85",
    ...
    # Vermuterias & Cocktail Bars
    {
        ...
        "image": "https://www.larosatroupe.com/med/img/imagenes/la-rosa-vermuteri-colmado/240521-larosa-0218.jpg",
        "location": "Palma",
    ...
    },
    {
        ...
        "image": "https://images.unsplash.com/photo-1767022724924-993b00fc04b3?w=800&q=85",
        "location": "Palma",
    ...
    },
    {
        ...
        "image": "https://images.unsplash.com/photo-1766844649151-f671c0ec206d?w=800&q=85",
        "location": "Palma",
    ...
    # New bars from full island list
    {
        ...
        "image": "https://images.unsplash.com/photo-1659103753313-5f8d41040ac4?w=800&q=85",
    ...
    },
    {
        ...
        "image": "https://images.unsplash.com/photo-1763054781554-862cb8dd6bc7?w=800&q=85",
        "location": "Palma",
        "full_address": "Palma, Mallorca",
        "hours": "Sunset - Late",
        "deal": {
...
async def send_contact_notification_email(inquiry: ContactInquiryCreate):
    ...
    logo_url = "https://golfmallorca-preview.preview.emergentagent.com/api/uploads/logo_email_padded.png"
    html_content = f"""
    <html>
    <body style="font-family: 'Helvetica Neue', Arial, sans-serif; padding: 0; margin: 0; background-color: #F5F2EB;">
        <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
            ...
            <div style="background: linear-gradient(135deg, #2D2D2D 0%, #3D3D3D 100%); padding: 30px 40px; border-radius: 16px 16px 0 0; text-align: center;">
                <img src="{logo_url}" alt="Golfinmallorca.com" style="max-width: 120px; height: auto; margin-bottom: 8px; display: inline-block;" />
...
async def send_bulk_email(request: Request, subject: str = "", message: str = ""):
    ...
    for sub in subscribers:
        try:
            ...
            <body style="font-family: 'Helvetica Neue', Arial, sans-serif; padding: 0; margin: 0; background-color: #F5F2EB;">
                <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
                    <div style="background: linear-gradient(135deg, #2D2D2D 0%, #3D3D3D 100%); padding: 40px 40px; border-radius: 16px 16px 0 0; text-align: center;">
                        <img src="{logo_url}" alt="Golfinmallorca.com" style="max-width: 140px; height: auto; margin-bottom: 10px; display: inline-block;" />
