      ...
      <div className="p-5 border-b border-slate-200 bg-white/70 backdrop-blur-sm">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-8 py-2.5 text-sm border border-stone-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-slate/20 focus:border-brand-slate"
