    ...
    <div className="flip-card-inner">
      ...
      <div className="flip-card-front bg-white border border-stone-100 shadow-sm rounded-2xl">
        ...
        <div className="p-5 pt-4">
          ...
          <Link to={`/golf-courses/${course.id}`} className="hover:text-brand-slate transition-colors">
      ...
      <div className="flip-card-back rounded-2xl p-6 text-white" style={{ background: 'linear-gradient(135deg, #2D2D2D 0%, #3D3D3D 100%)' }}>
        ...
        <div className="flex flex-col gap-2 mt-5">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 bg-white/15 text-white px-4 py-2 rounded-full text-xs font-medium hover:bg-white/25 transition-all border border-white/30"
