        ...
        <div className="p-6">
          {checkingAuth ? (
            ...
            <div className="py-4">
              ...
              <div className="mb-6">
                <h3 className="text-sm font-medium text-stone-600 mb-3 text-center">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-medium text-stone-600">Google</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs font-medium text-stone-600">Trustpilot</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs font-medium text-stone-600">TripAdvisor</span>
                  </a>
                </div>
              </div>
              ...
              {/* Internal Review via Google Sign-in */}
              <div className="text-center">
                ...
                >
                  <GoogleLogo />
                  <span>Sign in with Google to review here</span>
                </button>
                
                <p className="mt-3 text-xs text-stone-500">
                  Your email is kept private. Only your name appears with the review.
                </p>
              </div>
            </div>
          ) : (
